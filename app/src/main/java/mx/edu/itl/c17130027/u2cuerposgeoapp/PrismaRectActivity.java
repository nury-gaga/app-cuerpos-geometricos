...
:*
:*            Activity que muestra los datos del prisma rectangular.
:*
:*  Archivo     : PrismaRectActivity.java
...
public class PrismaRectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prisma_rect);
...
//--------------------------------------------------------------------------------------------------
    ...
    public void btnCalcRClick ( View v ){
...
//--------------------------------------------------------------------------------------------------
        ...
        //Realizamos el calculo para el prisma rectangular
        double aBase = ( Double.parseDouble ( edtAncho.getText ().toString () )
                * Double.parseDouble ( edtLargo.getText ().toString () ) );
        String aBaseFormat = decimalFormat.format ( aBase );

        double pBase = ( ( 2 * Double.parseDouble ( edtAncho.getText ().toString () ) )
                + ( 2 * Double.parseDouble ( edtLargo.getText ().toString () ) ) );
...
//--------------------------------------------------------------------------------------------------
        ...
        //Creamos el AlertDialog para mostrar los resultados del prisma rectangular
